    ...
    <div className='flex flex-col justify-center items-center text-white py-32 '>
      <div className="wrapper border bg-neutral-50/5 p-16 rounded-md">
        ...
        <div className="login-btn flex flex-col justify-center items-center py-3">
            ...
            <button onClick={()=> signIn('google')} type="button" className="text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 me-2 mb-2 w-[13.3rem]">
