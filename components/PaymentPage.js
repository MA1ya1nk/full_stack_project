      ...
      <div>
        <div className="head relative">
          ...
          <div className={`cover-pic min-h-[16vh]`}>
            <img
              src={`https://picsum.photos/1000/${Math.round(
                visualViewport.height / 2.1
              )}`}
              alt="img"
              className="w-screen border border-slate-700"
            />
          </div>
          <div className="profile-pic absolute -bottom-12 flex w-full justify-center">
            <img
              className="md:w-32 w-28 rounded-md"
              src={user?.profilepicture || "https://picsum.photos/400/400"}
              alt="profile-pic"
            />
        ...
        <div className="user my-16">
          ...
          <div className="flex justify-center text-zinc-500 text-center">
            <p>
              Long Covid advocacy, community, mutual aid, disability justice,
              poetry, and plants🪴
            </p>
          </div>
          <div className="flex justify-center text-zinc-500">
            <p>
              ...
              {supporters.reduce((a, b) => a + parseInt(b.amount), 0)} raised
            </p>
          </div>
        </div>
        <div className="payments flex md:flex-row flex-col max-w-full xl:mx-28 xl:gap-6 pb-16">
          <div className="supportersList md:w-1/2 bg-slate-800 rounded-lg m-4 md:p-8 p-4 md:h-96">
            ...
            <ul className="px-3 overflow-scroll md:h-64">
              ...
              {supporters.length === 0 && (
                <p className="text-center">No supporters yet</p>
              )}
            </ul>
          </div>
          <div className="support md:w-1/2 bg-slate-800 rounded-lg flex flex-col m-4 gap-2 md:p-8 p-4 md:h-96">
            ...
            <input
              ...
              name="name"
              className="w-full p-3 rounded-lg bg-slate-700 focus:outline-none hover:ring-white focus:ring-1"
              type="text"
            ...
            <input
              ...
              name="amount"
              className="w-full p-3 rounded-lg bg-slate-700 focus:outline-none hover:ring-white focus:ring-1 -moz-appearance:textfield -webkit-appearance:none arrow-hide"
              type="number"
              placeholder="Enter a amount"
            />
            <button
              className="bg-blue-900 hover:bg-blue-800 text-white p-3 rounded-lg disabled:hover:cursor-not-allowed disabled:hover:bg-blue-900"
